...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl = "https://media.journoportfolio.com/users/405725/images/5803a3a0-dd39-4880-980c-74de9dc5d158.jpg",
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      ...
      // iOS permission flow
      // @ts-expect-error: requestPermission not on all platforms
