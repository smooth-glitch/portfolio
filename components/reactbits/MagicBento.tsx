...
// If you want to pass data from pages, make this a prop (see bottom usage).
...
export default function MagicBento({
  ...
  clickEffect = true,
  enableMagnetism = true,
  cards, // optional override: use your own cards per section
}: {
  ...
  clickEffect?: boolean;
  enableMagnetism?: boolean;
  cards?: Array<{ color: string; title: string; description: string; label: string }>;
}) {
        ...
        {cardData.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              ...
              // CSS custom prop consumed by gradients/shadows
